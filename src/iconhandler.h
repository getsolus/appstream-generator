...
private:
     ...
     * stored under in the media export directory. Vector graphics and XPM
     * icons are rasterized/converted and stored as PNG.
     */
    static std::string iconStoreName(const std::string &iconName);
